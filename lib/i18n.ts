...
export const translations = {
  en: {
    ...
    hero: {
      ...
      title: "Sovereign AI. Built for your perimeter.",
      titleOptions: ["Sovereign AI. Built for your perimeter.", "Your AI. Your infrastructure. Your control.", "Private intelligence. Engineered end to end."],
    ...
    trust: {
      ...
      description: "Where client details must remain private, credibility comes from a checkable deployment shape, a redacted system summary, and a clear engagement promise.",
      referenceTitle: "Reference deployment spec",
      referenceDescription: "A concrete configuration ready to be replaced with verified VORTEX values.",
      architectureTitle: "Redacted architecture summary",
      architectureDescription: "A technical shape prepared for an approved, anonymized system summary.",
      guaranteeTitle: "Engagement guarantee",
      guaranteeDescription: "A falsifiable response window, shown only after the team confirms the actual commitment.",
      placeholder: "PLACEHOLDER — replace before publishing",
  ...
  ar: {
    ...
    hero: {
      ...
      titleOptions: ["ذكاء اصطناعي سيادي. مصمم داخل محيطك.", "ذكاؤك. بنيتك التحتية. سيطرتك.", "ذكاء خاص. نهندسه من البداية إلى النهاية."],
      rotatorLabel: "أنماط النشر",
      deployments: ["عناقيد معزولة", "استدلال داخلي", "RAG خاص على البيانات الداخلية", "استضافة نماذج سيادية"],
      description: "تبني VORTEX البنية التحتية الخاصة للذكاء الاصطناعي — والبرمجيات التي تعمل فوقها — من البداية إلى النهاية.",
    ...
    trust: { eyebrow: "الدليل الهندسي", title: "أظهر النظام.", description: "عندما يجب أن تبقى تفاصيل العملاء خاصة، تأتي المصداقية من شكل نشر قابل للتحقق، وملخص تقني منقح، ووعد واضح بالتعاون.", referenceTitle: "مواصفات نشر مرجعية", referenceDescription: "تهيئة تقنية جاهزة للاستبدال بقيم VORTEX الموثقة.", architectureTitle: "ملخص معماري منقح", architectureDescription: "شكل تقني مجهز لملخص نظام معتمد ومجهّل الهوية.", guaranteeTitle: "ضمان التعاون", guaranteeDescription: "إطار زمني واضح وقابل للمساءلة، يُعرض بعد تأكيد الالتزام الفعلي من الفريق.", placeholder: "نص مؤقت — يُستبدل قبل النشر", items: ["هندسة متكاملة Full-Stack", "تطوير أصلي بالذكاء الاصطناعي", "هندسة الويب والجوال", "إمكانات النشر الخاص", "المعمارية المؤسسية", "هندسة تضع الأمان أولاً", "ملكية كاملة من البداية للنهاية"] },
