...
export const translations = {
  en: {
    ...
    build: {
      ...
      title: "What We Build",
      subtitle: "From private infrastructure to premium digital experiences, VORTEX engineers complete technology systems.",
      explore: "Explore",
      ...
      web: { title: "Digital Experiences", short: "Premium websites, portals, and web platforms.", description: "High-performance corporate websites, interactive experiences, portals, and web applications engineered for clarity, speed, and scale.", points: ["Responsive design", "SEO-ready architecture", "CMS & analytics", "Accessibility", "Web applications", "Customer portals"], cta: "Explore Web Engineering" },
