...
export function MarketingFooter() {
  const { t } = useLanguage();
  return <footer className="section-wrap grid gap-10 border-t border-gold/15 py-12 text-xs text-muted sm:grid-cols-[0.8fr_1.2fr] sm:items-start"><div className="flex items-center gap-3.5"><div aria-hidden="true" className="grid h-10 w-10 place-items-center rounded-full border border-gold/30 bg-gold/10 text-gold"><Sparkles size={18} /></div><div><p className="text-sm font-bold tracking-tight text-cream">VORTEX</p><p className="mt-1 text-muted/70">{t("footer.location")}</p></div></div><div className="grid gap-8 sm:grid-cols-2"><nav aria-label="Capability navigation" className="flex flex-col items-start gap-3"><p className="font-mono text-[0.6rem] font-bold uppercase tracking-[0.14em] text-gold">Capabilities</p><Link href="/services/artificial-intelligence" className="focus-ring rounded-sm hover:text-champagne">Private AI & Intelligence</Link><Link href="/services/enterprise-software" className="focus-ring rounded-sm hover:text-champagne">Enterprise Platforms</Link><Link href="/services/web-development" className="focus-ring rounded-sm hover:text-champagne">Digital Experiences</Link><Link href="/services/mobile-development" className="focus-ring rounded-sm hover:text-champagne">Mobile Engineering</Link><Link href="/services/automation" className="focus-ring rounded-sm hover:text-champagne">Automation & Integration</Link><Link href="/services/infrastructure" className="focus-ring rounded-sm hover:text-champagne">Infrastructure</Link></nav><nav aria-label="Company navigation" className="flex flex-col items-start gap-3"><p className="font-mono text-[0.6rem] font-bold uppercase tracking-[0.14em] text-gold">Build with VORTEX</p><Link href="/engineering" className="focus-ring rounded-sm hover:text-champagne">Engineering</Link><Link href="/#architecture" className="focus-ring rounded-sm hover:text-champagne">{t("footer.architecture")}</Link><Link href="/#about" className="focus-ring rounded-sm hover:text-champagne">{t("footer.about")}</Link><Link href="/#contact" className="focus-ring rounded-sm hover:text-champagne">Start a Project</Link><a href="mailto:contact@vortexmind.co" className="focus-ring rounded-sm hover:text-champagne">{t("footer.email")}</a></nav></div></footer>;
}
