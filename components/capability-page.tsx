...
import { ServiceIdentity } from "@/components/service-identity";
...
export function CapabilityPage({ slug }: { slug: Exclude<ServiceSlug, "web-development"> }) {
  ...
  const ui = locale === "ar" ? {
    explore: "استكشف الخدمات", engineer: "ما نهندسه", system: "نظام", operational: "تشغيلي", architecture: "المعمارية · الهندسة · التكامل · النشر",
    ...
    explore: "Explore services", engineer: "What we engineer", system: "system", operational: "Operational", architecture: "Architecture · engineering · integration · deployment",
  ...
  return (
    <main id="main-content" className="min-h-screen pt-32 sm:pt-44">
      ...
      <section className="section-wrap pb-16 sm:pb-24">
        <ServiceIdentity slug={slug} />
      </section>
