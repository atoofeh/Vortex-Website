      ...
      <section className="relative overflow-hidden pb-24 sm:pb-36">
        ...
        <div className="section-wrap relative">
          <Link href="/#build" className="focus-ring inline-flex items-center gap-2 rounded-sm font-mono text-xs uppercase tracking-wider text-muted hover:text-champagne">
            <ArrowDown aria-hidden="true" size={14} className="rotate-90" /> Explore services
          </Link>
          <div className="mt-12 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <motion.div {...fadeUp(reducedMotion)}>
              <p className="eyebrow mb-5"><Globe2 aria-hidden="true" size={13} className="text-gold" /> Websites &amp; Web Apps</p>
              <h1 className="display max-w-4xl text-[clamp(3rem,8vw,7.2rem)] leading-[0.88] text-cream">Websites and apps that work for your business.</h1>
              ...
              <div className="mt-9 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
                ...
                <Link href="/#build" className="focus-ring inline-flex items-center gap-2 rounded-sm py-2 text-sm font-semibold text-champagne hover:text-cream">Explore services <ArrowRight aria-hidden="true" size={14} /></Link>
              </div>
            </motion.div>
