...
export const metadata: Metadata = {
  title: "About VORTEX Mind | AI & Enterprise Software Engineering in Jordan",
  description: "VORTEX Mind is a private AI infrastructure and enterprise software engineering firm headquartered in Amman, Jordan, serving Jordan, MENA, and the GCC.",
...
export default function AboutPage() {
    ...
    "@graph": [
      {
        ...
        "name": "About VORTEX Mind",
        "description": "VORTEX Mind is a private artificial intelligence infrastructure and enterprise software engineering firm headquartered in Amman, Jordan.",
      ...
      },
      {
        ...
        "description": "VORTEX Mind is a private artificial intelligence infrastructure and enterprise software engineering firm founded and headquartered in Amman, Jordan.",
  ...
  return <><SiteHeader /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><main id="main-content" className="min-h-screen pt-32 sm:pt-44">
    <section className="section-wrap pb-24 sm:pb-36"><div className="max-w-5xl"><p className="eyebrow mb-5"><Sparkles aria-hidden="true" size={13} className="text-gold" /> Who VORTEX is</p><h1 className="display max-w-5xl text-[clamp(3.2rem,8vw,7.6rem)] leading-[0.88] text-cream">VORTEX Mind: private AI and enterprise software engineering from Jordan.</h1><p className="mt-8 max-w-4xl text-xl leading-relaxed text-champagne sm:text-2xl">VORTEX (VORTEX Mind) is a private artificial intelligence infrastructure and enterprise software engineering firm founded and headquartered in Amman, Jordan, serving organizations across Jordan, the Middle East, and the GCC.</p><div className="mt-9 flex flex-wrap gap-3"><Link href="/?service=Private%20AI%20Architecture#contact" className="focus-ring inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-gold via-champagne to-gold px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-ink">Talk to VORTEX <ArrowRight aria-hidden="true" size={14} /></Link><Link href="/solutions" className="focus-ring inline-flex items-center gap-2 rounded-full border border-gold/30 px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-champagne hover:border-gold hover:text-cream">Explore solutions <ArrowRight aria-hidden="true" size={14} /></Link></div></div></section>
