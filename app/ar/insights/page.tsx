...
export const metadata: Metadata = { title: "رؤى هندسية ومخططات تقنية | VORTEX", description: "مخططات VORTEX التقنية عن نماذج اللغة الخاصة وRAG المؤسسي وتحديث الأنظمة البرمجية الحرجة.", alternates: { canonical: "/ar/insights", languages: { en: "/insights", ar: "/ar/insights", "x-default": "/insights" } } };
