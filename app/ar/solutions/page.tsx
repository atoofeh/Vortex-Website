...
export const metadata: Metadata = pageMetadata({ title: "حلول الذكاء الاصطناعي الخاص والأنظمة المؤسسية | VORTEX", description: "حلول VORTEX للبنية التحتية الخاصة للذكاء الاصطناعي وأنظمة RAG والأدوات الداخلية الآمنة للمؤسسات حول العالم.", alternates: { canonical: "/ar/solutions", languages: { en: "/solutions", ar: "/ar/solutions", "x-default": "/solutions" } } });
